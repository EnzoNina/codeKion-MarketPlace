...
$.ajax({
    url: "/solicitudes/getNotificaciones",
    type: "GET",
    dataType: "json",
    success: function (data) {
        ...
        if (data.length === 0) {
            ...
            $.each(data, function (index, notificacion) {
                var fila = "<tr><td>" + notificacion.idProyecto.id + "</td><td>" + notificacion.idProyecto.nombreProyecto + "</td><td>" + notificacion.idProyecto.urlProyecto + "</td><td>" + notificacion.idProyecto.descripcionProyecto + "</td><td>" + notificacion.idProyecto.estadoProyecto + "</td><td><a href='/solicitudes/aceptarSolicitud/" + notificacion.id + "'>Aceptar solicitud</a></td></tr>";
